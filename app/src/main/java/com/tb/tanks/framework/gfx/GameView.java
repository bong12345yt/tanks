...
import com.tb.tanks.tankGame.screens.LevelCompleteScreen;

/**
 * extends SurfaceView to perform continuous rendering in a separate thread that
 * could also house our games main loop. It keeps a reference to a Game
...
class GameView extends SurfaceView implements SurfaceHolder.Callback {
	...
	class GameThread extends Thread {
       ...
       public static final int STATE_PAUSE = 2;
        ...
        public static final float FRAME_RATE = 1000/60;
        ...
        private void updateGame() {
          ...
          //  if (mLastTime > now) 
            ...
            mLastTime = now;
            if (switchTime>25){
				game.getCurrentScreen().update(deltaTime/1000);
			}


			game.getCurrentScreen().paint(deltaTime);

            float wait = FRAME_RATE - deltaTime;
            if(wait > 0) {
                try {
