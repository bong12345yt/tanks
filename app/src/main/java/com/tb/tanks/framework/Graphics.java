...
public interface Graphics {
	 ...
	 * images). The filename specifies an asset in our applications APK file.
	 * 
	 * @param fileName
	 * @param format
	 * @return
	 ...
	 * color. Any portion of the line that is outside the framebuffers raster
	 * will be ignored.
	 * 
	 * @param x
	 * @param y
	 ...
	 * (x,y) specifies the position of the rectangles top-left corner in the
	 ...
	 * to the framebuffer. The (x,y) coordinates specify the top-left corners
	 * position of the Pixmaps target location in the framebuffer. The
	 * arguments srcX and srcY specify the corresponding top-left corner of the
	 * rectangular region that is used from the Pixmap, given in the Pixmaps
	 ...
	 * The Graphics.drawPixmap() method draws rectangular portions of a Pixmap
	 * to the framebuffer. The (x,y) coordinates specify the top-left corners
	 * position of the Pixmaps target location in the framebuffer \n. Note that
